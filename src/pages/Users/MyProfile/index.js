...
import {
  deleteUserProfile,
  getEmployeesByID, postUserProfile,
  updateEmployee
} from "service/api";
...
const MyProfile = () => {
  ...
  return (
    <Base title="My Profile" headerType={2}>
      {isLoading ? (
        <LoadingSpinner />
      ) : (
        <>
                ...
                <Column className="flex flex-col justify-start w-[100%]">
                  ...
                  <Column className="flex flex-col items-center justify-start sm:mt-[12px] md:mt-[16px] mt-[32px] sm:mx-[0] sm:px-[0] rounded-radius8 sm:w-[100%] w-[100%]">
                    <Column className="flex flex-col items-center justify-start w-[100%] gap-6">
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[12px] sm:mt-[9px] w-[100%]">
                        <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] sm:px-[0] rounded-radius8 sm:w-[100%] w-[45%]">
                          <Text
                            className="font-medium text-black_901 w-[auto]"
                            as="h6"
                            variant="h6"
                          ...
                          <Datepicker
                            className="w-[65%] ml-10 rounded-radius8 bg-bluegray_50 p-[10px] sm:p-[5px] md:p-[7px]"
                            name="joining_date"
                            onChange={(e) => {
